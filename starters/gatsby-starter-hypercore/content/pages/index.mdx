...
<p>
  The following greeting is coming from frontmatter: 
</p>

<h2>{props.store.greeting} {props.store.recipient}</h2>

This is a plain image in markdown that is automatically optimized:
